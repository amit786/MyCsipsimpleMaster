...
//		//setWizardId("BASIC");
		...
		final PreferencesWrapper prefs = new PreferencesWrapper(getApplicationContext());
		prefProviderWrapper.setPreferenceBooleanValue(PreferencesWrapper.FIRST_LAUNCH, true);
...
//		account.TEMP_DATA = username;
//		account.TEMP_IMEI = IMEI;
